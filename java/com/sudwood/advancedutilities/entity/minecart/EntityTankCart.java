...
public class EntityTankCart extends EntityMinecart{

	public FluidTank tank = new FluidTank(FluidContainerRegistry.BUCKET_VOLUME*64);
	public EntityTankCart(World par1World, double par2, double par4, double par6) {
		super(par1World, par2, par4, par6);
		// TODO Auto-generated constructor stub
	}
	public EntityTankCart(World par1World)
    {
        super(par1World);
    }
    ...
    {
    	return new EntityTankCart(par0World, par1, par3, par5);
    }
	@Override
    public Block func_145817_o()
    {
		return AdvancedUtilitiesBlocks.dummyTank;
    }
