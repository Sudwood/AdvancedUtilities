...
public class EntitySpeedyTankCart extends EntityMinecart{
	...
	public EntitySpeedyTankCart(World par1World, double par2, double par4, double par6) {
		super(par1World, par2, par4, par6);
		// TODO Auto-generated constructor stub
	}
	public EntitySpeedyTankCart(World par1World)
    {
        super(par1World);
    }
    ...
    {
    	return new EntitySpeedyTankCart(par0World, par1, par3, par5);
    }
	@Override
