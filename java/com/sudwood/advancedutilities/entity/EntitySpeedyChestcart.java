...
public class EntitySpeedyChestcart extends EntityMinecartChest
{

	public EntitySpeedyChestcart(World par1World) 
	{
		super(par1World);
	}
	
	public EntitySpeedyChestcart(World par1World, double par2, double par4, double par6)
    {
    ...
    {
    	return new EntitySpeedyChestcart(par0World, par1, par3, par5);
    }
