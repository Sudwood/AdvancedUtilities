...
public class TileEntityStoneMill extends TileEntity implements ISidedInventory
{
    ...
    public void readFromNBT(NBTTagCompound p_145839_1_)
    {
        ...
        this.grindTime = p_145839_1_.getShort("GrindTime");
    ...
    public void writeToNBT(NBTTagCompound p_145841_1_)
    {
        ...
        p_145841_1_.setShort("GrindTime", (short)this.grindTime);
    ...
    public int getGrindProgressScaled(int p_145953_1_)
    {
        return this.grindTime * p_145953_1_ / 1000;
    }
    ...
    {
    		if(inventory[1]!=null && CrushRecipes.getCrushResult(inventory[1])!=null && inventory[0]!=null && inventory[0].getItem() == Item.getItemFromBlock(Blocks.cobblestone))
    		{
    			if(inventory[2]== null)
    				return true;
    			ItemStack temp = CrushRecipes.getCrushResult(inventory[1]);
    			temp.stackSize = CrushRecipes.getCrushResultNumber(inventory[1]);
    ...
    {
        if(item.getItem() == Item.getItemFromBlock(Blocks.cobblestone) && par1 == 0)
        {
        	return true;
        }
