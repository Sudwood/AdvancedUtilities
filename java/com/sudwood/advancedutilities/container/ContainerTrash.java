...
{
    private TileEntityTrash furnace;
    private int lastGrindTime = 0;
    private int sizeInventory = 0;
    public ContainerTrash(InventoryPlayer par1InventoryPlayer, TileEntityTrash par2TileEntityFurnace)
    {
        this.furnace = par2TileEntityFurnace;
        sizeInventory = furnace.getSizeInventory();
        this.addSlotToContainer(new Slot(par2TileEntityFurnace, 0, 80, 34));
