...
public class ContainerFluidTube extends Container
{
    private TileEntityFluidTube tileFurnace;
    private int lastTankAmount;
    private int lastProgressTime;

    public ContainerFluidTube(InventoryPlayer par1InventoryPlayer, TileEntityFluidTube par2TileEntitySteamBoiler)
    {
