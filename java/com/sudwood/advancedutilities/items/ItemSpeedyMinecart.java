...
public class ItemSpeedyMinecart extends Item
{
    ...
    public ItemSpeedyMinecart(int p_i45345_1_)
    {
    ...
    {
    	this.itemIcon = par1IconRegister.registerIcon(AdvancedUtilities.MODID+":"+"speedyminecart");
    }
}