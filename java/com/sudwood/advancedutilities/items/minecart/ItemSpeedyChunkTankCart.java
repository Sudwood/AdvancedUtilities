...
public class ItemSpeedyChunkTankCart extends Item
{
    ...
    public ItemSpeedyChunkTankCart(int p_i45345_1_)
    {
    ...
    {
    	this.itemIcon = par1IconRegister.registerIcon(AdvancedUtilities.MODID+":"+"speedychunktankcart");
    }
}