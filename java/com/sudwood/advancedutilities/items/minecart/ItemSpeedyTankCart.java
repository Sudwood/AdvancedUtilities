...
public class ItemSpeedyTankCart extends Item
{
    ...
    public ItemSpeedyTankCart(int p_i45345_1_)
    {
    ...
    {
    	this.itemIcon = par1IconRegister.registerIcon(AdvancedUtilities.MODID+":"+"speedytankcart");
    }
}