...
public class ItemSpeedyChestcart extends Item
{
    ...
    public ItemSpeedyChestcart(int p_i45345_1_)
    {
    ...
    {
    	this.itemIcon = par1IconRegister.registerIcon(AdvancedUtilities.MODID+":"+"speedychestcart");
    }
}