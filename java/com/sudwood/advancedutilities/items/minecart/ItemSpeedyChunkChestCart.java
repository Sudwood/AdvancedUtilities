...
public class ItemSpeedyChunkChestCart extends Item
{
    ...
    public ItemSpeedyChunkChestCart(int p_i45345_1_)
    {
    ...
    {
    	this.itemIcon = par1IconRegister.registerIcon(AdvancedUtilities.MODID+":"+"speedychunkchestcart");
    }
}