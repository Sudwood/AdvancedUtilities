...
public class ItemChunkChestCart extends Item
{
    ...
    public ItemChunkChestCart(int p_i45345_1_)
    {
    ...
    {
    	this.itemIcon = par1IconRegister.registerIcon(AdvancedUtilities.MODID+":"+"chunkchestcart");
    }
}