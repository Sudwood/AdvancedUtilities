...
public class ItemChunkTankCart extends Item
{
    ...
    public ItemChunkTankCart(int p_i45345_1_)
    {
    ...
    {
    	this.itemIcon = par1IconRegister.registerIcon(AdvancedUtilities.MODID+":"+"chunktankcart");
    }
}