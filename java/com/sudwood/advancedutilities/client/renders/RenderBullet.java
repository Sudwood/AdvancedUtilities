...
{
    private static final ResourceLocation arrowTextures = new ResourceLocation("advancedutilities", "textures/entity/bullet.png");
     ...
     */
    public void doRender(EntityBullet par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
