...
public class RenderQuarryFrame extends TileEntitySpecialRenderer
{
	ModelQuarryFrame model = new ModelQuarryFrame();
	ResourceLocation texture = new ResourceLocation("advancedutilities","textures/blocks/quarryframe.png");  
	int thisMeta = 0;
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
       ...
       // adjustRotatePivotViaMeta(te.getWorldObj(), te.xCoord, te.yCoord, te.zCoord);//comment line "rotation 1" and uncomment this line if it doesnt work. 
        ...
        TileEntityQuarryFrame tile = (TileEntityQuarryFrame) te;
