...
public class RenderRestrictedItemTube extends TileEntitySpecialRenderer
{
	...
	ResourceLocation texture = new ResourceLocation("advancedutilities","textures/blocks/restricteditemtube.png");  
	int thisMeta = 0;
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        ...
        TileEntityRestrictedItemTube tile = (TileEntityRestrictedItemTube) te;
