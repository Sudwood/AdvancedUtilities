...
public class RenderRebreather implements IItemRenderer{

	AdvancedModelBase model;
	ResourceLocation texture;
	public RenderRebreather(AdvancedModelBase mod, ResourceLocation res)
	{
		model = mod;
		texture = res;
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) 
	{
		...
		case EQUIPPED_FIRST_PERSON:
		{
			GL11.glPushMatrix();
			  ...
			  GL11.glTranslatef(1.0F, -0.4F, -0.2F);   
