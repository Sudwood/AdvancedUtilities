...
public class RenderRunningShoesItem implements IItemRenderer{

	AdvancedModelBase model;
	ResourceLocation texture;
	public RenderRunningShoesItem(AdvancedModelBase mod, ResourceLocation res)
	{
		model = mod;
		texture = res;
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) 
	{
		...
		case INVENTORY:
		{
			...
			GL11.glTranslatef((float)0.5F, (float) 0.5F, (float)0.5F);
			  GL11.glRotatef(180F, 40.0F, 0.0F, 1.0F);
			  GL11.glTranslatef(-0.5F, -0.8F, 0.47F);      
		...
		case EQUIPPED: 
		{
			...
			GL11.glTranslatef((float)0.5F, (float) 0.5F, (float)0.5F);
			  ...
			  GL11.glTranslatef(0.4F, -0.9F, -0.28F);      
		...
		case EQUIPPED_FIRST_PERSON:
		{
			GL11.glPushMatrix();
			  ...
			  GL11.glTranslatef(0.3F, -2F, -0.3F);   
