...
public class RenderSteamQuarry extends TileEntitySpecialRenderer
{
	ModelSteamQuarry model = new ModelSteamQuarry();
	ResourceLocation texture = new ResourceLocation("advancedutilities","textures/blocks/steamquarry.png");  
