...
public class RenderSteamSmeltry extends TileEntitySpecialRenderer
{
	ModelSteamSmeltry model = new ModelSteamSmeltry();
	ResourceLocation texture = new ResourceLocation("advancedutilities","textures/blocks/steamsmeltry.png");
