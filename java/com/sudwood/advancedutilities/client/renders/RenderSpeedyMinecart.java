...
public class RenderSpeedyMinecart extends Render
{
    private static final ResourceLocation minecartTextures = new ResourceLocation(AdvancedUtilities.MODID, "textures/entity/speedyminecart.png");
    /**
