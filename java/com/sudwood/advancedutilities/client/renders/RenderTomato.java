...
public class RenderTomato implements IItemRenderer{

	AdvancedModelBase model;
	ResourceLocation texture;
	public RenderTomato(AdvancedModelBase mod, ResourceLocation res)
	{
		model = mod;
		texture = res;
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) 
	{
		...
		case INVENTORY:
		{
			...
			GL11.glTranslatef((float)0.5F, (float) 0.5F, (float)0.5F);
			  ...
			  GL11.glTranslatef(-0.7F, -1.27F, 0.5F);      
		...
		case EQUIPPED_FIRST_PERSON:
		{
			GL11.glPushMatrix();
			  ...
			  GL11.glTranslatef(0.3F, -1.9F, -0.3F);   
