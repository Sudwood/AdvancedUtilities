...
{
	ModelBellows model = new ModelBellows();
	ResourceLocation texture = new ResourceLocation("advancedutilities","textures/blocks/bellows.png");
   ...
   private void adjustRotatePivotViaMeta(World world, int x, int y, int z) {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        ...
        GL11.glTranslatef(0.058F,-((TileEntityBellows)te).getYScale()+1, 0.0F); 
        GL11.glScalef(1, ((TileEntityBellows)te).getYScale(), 1);
