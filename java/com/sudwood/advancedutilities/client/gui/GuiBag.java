...
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("advancedutilities","textures/gui/baggui.png");
    private static final String __OBFID = "CL_00000758";
    private final InventoryBag inventory;
    private NBTTagCompound tag;

    public GuiBag(ContainerBag containerItem, ItemStack gun)
    {
	    super(containerItem);
