...
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("advancedutilities","textures/gui/steamfurnacegui.png");
    private TileEntitySteamFurnace tile;
    private static final String __OBFID = "CL_00000758";

    public GuiSteamFurnace(InventoryPlayer par1InventoryPlayer, TileEntitySteamFurnace par2TileEntitySteamFurnace)
    {
        super(new ContainerSteamFurnace(par1InventoryPlayer, par2TileEntitySteamFurnace));
    ...
    {
        this.fontRendererObj.drawString("Steam Furnace", this.xSize / 4 - this.fontRendererObj.getStringWidth("Steam Furnace") / 2, 3, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        ...
        this.drawTexturedModalRect(k + 39, l + 30, 176, 14, i1 + 1, 16);
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if(par1 >= 39+var5 && par2 >= 30+var6 && par1 <= 60+var5 && par2 <= 44+var6)
		{
