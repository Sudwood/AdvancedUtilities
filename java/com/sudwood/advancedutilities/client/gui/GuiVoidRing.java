...
public class GuiVoidRing extends GuiContainer
{
    ...
    {
        this.fontRendererObj.drawString("Void Ring", this.xSize / 2 - this.fontRendererObj.getStringWidth("Void Ring") / 2, 6, 4210752);
