...
public class BlockKiln extends BlockContainer
{
	...
	protected BlockKiln(Material mat) {
		super(mat);
	...
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!false)
        {
            TileEntityKiln tileentityfurnace = (TileEntityKiln)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random p_149734_5_)
    {
			...
			if( ((TileEntityKiln)world.getTileEntity(x, y, z)).isBurning())
			{
	 ...
	 public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	    {
	        ...
	        else
	        {
	            ...
	            if (var10 != null&& var10 instanceof TileEntityKiln)
	            {
	            	par5EntityPlayer.openGui(AdvancedUtilities.instance, AdvancedUtilities.kilnGui, par1World, par2, par3, par4);
	            }
